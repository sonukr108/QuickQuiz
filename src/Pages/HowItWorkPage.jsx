...
const HowItWorkPage = () => {
  return (
    <div className='min-h-[70vh] md:min-h-[80vh] p-[8%] lg:py-10'>
      ...
      <button className='w-fit border-2 hover:text-black dark:hover:text-white border-black dark:border-white py-2 px-4 hover:rounded-xl hover:shadow-[0px_3px_6px_rgba(0,0,0,0.16),_0px_3px_6px_rgba(0,0,0,0.23)] transition-all duration-300'><Link to='/'>Start playing</Link></button>
      </div>
