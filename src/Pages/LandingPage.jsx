    ...
    <div className='min-h-[70vh] md:min-h-[80vh] w-full p-[8%] flex lg:py-7'>
      <div className="left w-full flex justify-center flex-col gap-10">
        ...
        <div className="buttons flex flex-col md:flex-row gap-4 md:gap-5 font-semibold text-lg xl:text-xl text-gray-700 dark:text-gray-400">
          <button className='w-fit border-2 hover:text-black dark:hover:text-white border-black dark:border-white py-2 px-4 hover:rounded-xl hover:shadow-[0px_3px_6px_rgba(0,0,0,0.16),_0px_3px_6px_rgba(0,0,0,0.23)] transition-all duration-300'><Link to='/login'>Start Solving</Link></button>
